...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // If registration succeeded and the backend marked this as a new user, send them to onboarding
      if (newUser) {
        navigate("/onboarding");
      } else {
    ...
    <div style={{ minHeight: "90vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "20px" }}>
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" disabled={loading} style={{ width: "100%", padding: "14px", fontSize: "1rem", marginTop: "10px", background: "" }}>
